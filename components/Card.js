...
function Card(props) {
    return (
        <div className="grid  place-items-center  font-mono m-4 pt-10">
            <div className="bg-white  h-80 w-64 rounded-md shadow-xl  dark:bg-gray-800">
                ...
                <div className="p-3">
                    <p className="block mb-1 font-semibold dark:text-gray-200 ">{props.title}</p>
                    <p className="text-xs tracking-tighter text-gray-600 dark:text-gray-400">{props.description}</p>
                </div>
                <div className="flex justify-between items-center p-2">
                    <img src="/images/logo2.webp" alt="avatar"  className="rounded-full h-7"/>
                    <div className="flex">
                        <button href={props.code} className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-0 px-4 border border-blue-500 hover:border-transparent rounded">
                            Code
                        </button>

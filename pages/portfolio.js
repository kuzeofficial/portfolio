            ...
            <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
                <div >
                        ...
                        <div class="flex flex-wrap overflow-hidden">
                            <div class="w-full overflow-hidden sm:w-full md:w-full lg:w-1/2 xl:w-1/2 ">
                                <Card image="/images/ui_food_delivery_app.webp" title="Hello" description="My name is Cristian"/>
                            </div>
                            <div class="w-full overflow-hidden sm:w-full md:w-full lg:w-1/2 xl:w-1/2 ">
                                <Card image="/images/ui_food_delivery_app.webp" title="Hello" description="My Name is Cristian"/>
                            </div>

...
export default function Container(props){
    ...
    const meta = {
        ...
        image:'https://cristianfonseca.com/static/images/banner.png',
        type:'website',
        ...customMeta
    }
    ...
    return (
        <div className="bg-white dark:bg-black">
            ...
            <nav className="flex items-center justify-between w-full max-w-4xl  pt-2  mx-auto my-0 text-gray-900 bg-white sticky-nav md:my-8 dark:bg-black bg-opacity-70 dark:text-gray-100">
